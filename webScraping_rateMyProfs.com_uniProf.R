...
# It extracts information about popularities of professors in various universities  
...
# Part 2 uses this information of part 1 and scrapes individual page of each 
...
list2012 <- readLines("http://www.ratemyprofessors.com/toplists/getxmlfromstatic.jsp?file=top100ProfessorsUniv_2012.xml")
list2011 <- readLines("http://www.ratemyprofessors.com/toplists/getxmlfromstatic.jsp?file=top100ProfessorsUniv_2011.xml")
list2010 <- readLines("http://www.ratemyprofessors.com/toplists/getxmlfromstatic.jsp?file=top100ProfessorsUniv_2010.xml")
list2009 <- readLines("http://www.ratemyprofessors.com/toplists/getxmlfromstatic.jsp?file=top100ProfessorsUniv_2009.xml")
...
# Part 2
# Scrape 'individual page' of each 'Highest Rated' University Professors 
...
write.xlsx(df, 'ratingsUNI_prof.xlsx', sheetName='1', row.names=F, append=F)  
